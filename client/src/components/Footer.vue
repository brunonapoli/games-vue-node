<template>
    <div>
        <footer class="footer">
            <a>Elaborado por Napoli Bruno</a>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin logo" viewBox="0 0 16 16">
                <a href="https://www.linkedin.com/in/napoli-bruno/">    
                    <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 
                        1.146-1.175 1.146H1.175C.526 16 0 15.487 0 
                        14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 
                        1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github logo" viewBox="0 0 16 16">
                <a href="https://github.com/brunonapoli">
